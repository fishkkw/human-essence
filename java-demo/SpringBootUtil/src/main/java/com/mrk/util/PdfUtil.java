...
public class PdfUtil {
    public static void main(String[] args) throws Exception {
        ...
        try {
            String pdfFileName = "E:\\GIT\\rldyjh\\human-essence\\learning-materials\\白帽子讲WEB安全 纪念版.pdf";
            ...
            for (int i = 0; i < pageNumber; i++) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (resources.isImageXObject(cosName)) {
                        ...
                        File outImgFile = new File("E:\\文件资料\\baiduDownload\\img\\" + System.currentTimeMillis() + ".jpg");
